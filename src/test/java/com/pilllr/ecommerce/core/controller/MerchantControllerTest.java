...
public class MerchantControllerTest {
    ...
    public void setup(){
        ...
        when(mockMerchantTransformer.getLocalDomainObjectFromDTO((com.pilllr.persistence.domain.Merchant)any())).thenReturn(getMockMerchantWithPaymentProvider(1l));
    ...
    public void shouldPostMerchant() throws Exception {
        com.pilllr.persistence.domain.Merchant mockInputMerchant = getMockMerchantDTO(null);
    ...
    public void shouldUpdateMerchant() throws Exception {
        com.pilllr.persistence.domain.Merchant mockInputMerchant = getMockMerchantDTO(1l);
    ...
    private com.pilllr.persistence.domain.Merchant getMockMerchantDTO(Long id){
        com.pilllr.persistence.domain.Merchant merchantDTO = new com.pilllr.persistence.domain.Merchant();
    ...
    private List<com.pilllr.persistence.domain.Merchant> getMockMerchantDTOList(){
        List<com.pilllr.persistence.domain.Merchant> merchantDTOList = new ArrayList<com.pilllr.persistence.domain.Merchant>();
