...
public class PaymentProviderControllerTest {
    ...
    private com.pilllr.persistence.domain.PaymentProvider getMockPaymentProviderDTO(String name) {
        com.pilllr.persistence.domain.PaymentProvider paymentProviderDTO = new com.pilllr.persistence.domain.PaymentProvider();
