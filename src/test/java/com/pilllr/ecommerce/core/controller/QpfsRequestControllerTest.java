...
import com.pilllr.persistence.domain.*;
...
public class QpfsRequestControllerTest {
    ...
    public void shouldPostQPfsRequest() throws Exception {
        ...
        com.pilllr.ecommerce.core.domain.Order mockOutputOrder = getMockOrder(null);
        mockOutputOrder.setId(1l);

        when(mockMerchantService.get(anyLong())).thenReturn(getMockMerchant());
        when(mockOrderService.persist((com.pilllr.ecommerce.core.domain.Order)any())).thenReturn(mockOutputOrder);
	...
	private com.pilllr.ecommerce.core.domain.Order getMockOrder(Long id) {
    ...
    private com.pilllr.ecommerce.core.domain.Merchant getMockMerchant() {
