...
public class MerchantIntegrationTest {
    ...
    private void populateMockMerchant() throws Exception {
        com.pilllr.persistence.domain.Merchant merchant = getMerchantDomainDTO("TEST");
    ...
    public void shouldUpdateMerchant() throws Exception {
        ...
        com.pilllr.persistence.domain.Merchant merchant = getMerchantDomainDTO("TEST1");
        merchant.setId(1l);
	...
	public void shouldNotUpdateMerchant() throws Exception {
		...
		com.pilllr.persistence.domain.Merchant merchant = new com.pilllr.persistence.domain.Merchant();
    ...
    private com.pilllr.persistence.domain.Merchant getMerchantDomainDTO(String name) {
        com.pilllr.persistence.domain.Merchant merchant = new com.pilllr.persistence.domain.Merchant();
        merchant.setName(name);
        com.pilllr.persistence.domain.PaymentProvider paymentProvider = new com.pilllr.persistence.domain.PaymentProvider();
