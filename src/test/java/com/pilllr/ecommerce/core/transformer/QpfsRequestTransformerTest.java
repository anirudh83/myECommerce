...
import com.pilllr.persistence.domain.Address;
...
public class QpfsRequestTransformerTest {
	...
	public void testShouldGetOrderFromQpfsRequest() {
		...
		com.pilllr.persistence.domain.Order orderDTO = new com.pilllr.persistence.domain.Order();
		...
		com.pilllr.ecommerce.core.domain.CreditCard creditCard = order.getCreditCard();
		...
		Set<com.pilllr.ecommerce.core.domain.Product> products = order.getProducts();
	...
	public void testShouldPopulateShippingAddress() {
		...
		com.pilllr.ecommerce.core.domain.Address shippingAddress = custAddress.getAddress();
	...
	public void testShouldPopulateBillingAddress() {
		...
		com.pilllr.ecommerce.core.domain.Address billingAddress = customerAddress.getAddress();
