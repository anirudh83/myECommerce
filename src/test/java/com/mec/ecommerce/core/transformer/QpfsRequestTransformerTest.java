...
public class QpfsRequestTransformerTest {
	...
	public void testShouldGetOrderFromQpfsRequest() {
		...
		com.mec.ecommerce.core.domain.CreditCard creditCard = order.getCreditCard();
		...
		Set<com.mec.ecommerce.core.domain.Product> products = order.getProducts();
	...
	public void testShouldPopulateShippingAddress() {
		...
		com.mec.ecommerce.core.domain.Address shippingAddress = custAddress.getAddress();
	...
	public void testShouldPopulateBillingAddress() {
		...
		com.mec.ecommerce.core.domain.Address billingAddress = customerAddress.getAddress();
