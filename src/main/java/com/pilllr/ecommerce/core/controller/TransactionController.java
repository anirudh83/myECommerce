...
import com.pilllr.ecommerce.core.controller.exception.NoSuchTransactionExists;
import com.pilllr.ecommerce.core.domain.Transaction;
import com.pilllr.ecommerce.core.service.TransactionService;
import com.pilllr.persistence.domain.TransactionStatus;
...
public class TransactionController {
    ...
    public Transaction getTransaction(@PathVariable String pilllrTransactionId) {
        LOGGER.info("****************** GET Transaction with pilllr Transaction id: " + pilllrTransactionId);
    ...
    public Object updateTransaction(@RequestBody TransactionStatus transactionStatus) {
        LOGGER.info("****** REQUEST RECEIVED TO update TRANSACTION status with pilllr Txn id : " + transactionStatus.getPilllrTransactionId() + "**************");
    ...
    public Object createTransaction(@RequestBody TransactionStatus transactionStatus) {
        LOGGER.info("****** REQUEST RECEIVED TO create new transaction status with pilllr Txn id : " + transactionStatus.getPilllrTransactionId() + "**************");
