...
import com.mec.ecommerce.core.controller.exception.NoPaymentProviderProvidedException;
...
public class MerchantController {
    ...
    public Merchant updateMerchant(@RequestBody Merchant merchant){
        ...
        try {
            com.mec.ecommerce.core.domain.Merchant existingMerchant = merchantService.get(merchant.getId());
